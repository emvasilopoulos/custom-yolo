...
LOSS_TYPE = (
    custom_yolo_lib.experiments.loss_factory.LossType.THREESCALE_YOLO_ORD_v3_GAUSSIAN_RADIAL_DECAY
)
DATASET_TYPE = (
    custom_yolo_lib.experiments.dataloaders_factory.DatasetType.COCO_SAMA_AUGMENT
)
SCHEDULER_TYPE = (
    custom_yolo_lib.experiments.schedulers_factory.SchedulerType.WARMUP_COSINE_2_CYCLES
)
BASE_LR = 0.01 / 64
